# V1 Benchmark Report (Archived) — See v2_report.py for V2 results
...
- **Run Directory:** `benchmark/results/full_run_20260204_140715`
- **Log File:** `benchmark/results/full_run_20260204_140715/full_benchmark.log`
- **Crash Log:** `benchmark/results/full_run_20260204_140715/crash_log.json`
- **Report File:** `benchmark/results/benchmark_report_20260204_140715.md`

### Individual Result Files

```
benchmark/results/full_run_20260204_140715/
├── pass1/
│   ├── humaneval/
│   ├── mbpp/
│   └── custom/
