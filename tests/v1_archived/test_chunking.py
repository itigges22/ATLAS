"""
Tests for chunking module (V1 — ARCHIVED).

Validates code chunking for different languages,
chunk size limits, and overlap handling.

NOTE: Archived V1 test. The chunking module was removed in V2 (replaced by
PageIndex AST-aware retrieval). This file is retained for reference only and
is excluded from test collection via pyproject.toml collect_ignore.
"""
